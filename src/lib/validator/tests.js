...
// Regex modified from the above to require a TLD of at least two characters, but allow single character subdomains
const EMAIL_REGEX = /^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])+)$/;
 ...
 * @example (5, 'hey') => false
 * @example (5, ['a', 'b', 'c']) => false
 * @example (5, ['a', 'b', 'c', 'd', 'e', 'f']) => false
 */
export function length (length, value) {
